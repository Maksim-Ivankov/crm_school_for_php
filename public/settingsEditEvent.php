...
<?php include $_SERVER['DOCUMENT_ROOT'].("/templates/nav.php"); ?>
        <div class="rightMainWrap">
            ...
            <div class="newCourses newCoursesEditEvent searchResultAjaxIdStudent">
                ...
                <a class="buttonNewCourses buttonNewCoursesEvent" onclick="editEventFunc()">Изменить мероприятие</a>
                <a class="buttonNewCourses buttonNewCoursesEvent buttonUpdateStatusEvent"  onclick="updateStatusEvent()"></a>
                <a class="buttonNewCourses buttonNewCoursesEvent" onclick="deleteEvent()">Удалить мероприятие</a>
            </div>
                ...
                <table class="ourStudentTable ourStudentTablePay">
                    <tr class="ourStudentTableTr ourStudentTableTrTitle">
                        ...
                        <td class="ourStudentTableTd ourStudentTableTdTitle">Стоимость</td>
                        <td class="ourStudentTableTd ourStudentTableTdTitle">Статус</td>
                    </tr>
                <?
                    $ourEvents = getAll($link,'event');
                    $countEvents = 1;
                    foreach($ourEvents as $ourEventsItem){
                        ?>
                        <tr class="trHoverEditEvents" title="<?=$ourEventsItem['id']?>" onclick="changeEventForEditEvent(this)">
                            ...
                            <td class="ourStudentTableTd editEventTableCountPeople ourStudentTableTdTitleEditEvent"><?=$ourEventsItem['countPeople']?></td>
                            ...
                            <td class="ourStudentTableTd editEventTablePrice ourStudentTableTdTitleEditEvent"><?=$ourEventsItem['price']?></td>
